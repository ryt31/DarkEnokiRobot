...
[ExecuteInEditMode]
public class CameraPlay_Pixel : MonoBehaviour
{
    #region Variables
    public Shader SCShader;
    private string ShaderName = "CameraPlay/Pixel";
    ...
    [HideInInspector] public float PixelSize = 4;
    ...
    void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
    {
        if (SCShader != null)
        {
            ...
            curve.AddKey(0.75f, 1.00f);
            curve.AddKey(0.88f, 1.00f);
            curve.AddKey(1, 1);
