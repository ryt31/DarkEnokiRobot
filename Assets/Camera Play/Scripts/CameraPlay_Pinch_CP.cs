...
{
    /// <summary>
    /// Add a Pinch to the current camera, and remove it automatically after the animation is end. By default, the timer duration is set to 1 second.
    /// </summary>
    public static void Pinch()
    {
        if (CurrentCamera == null) CurrentCamera = Camera.main;
        CameraPlay_Pinch CP = CurrentCamera.gameObject.AddComponent<CameraPlay_Pinch>() as CameraPlay_Pinch;
    ...
    public static void Pinch(float x, float y)
    {
        if (CurrentCamera == null) CurrentCamera = Camera.main;
        CameraPlay_Pinch CP = CurrentCamera.gameObject.AddComponent<CameraPlay_Pinch>() as CameraPlay_Pinch;
        CP.PosX = x;
    ...
    /// <summary>
    /// Add a Pinch to the current camera, and remove it automatically after the animation is end.
    /// </summary>
    /// <param name="x">The x position of the effect. 0 = left side of the screen. 1 = Right side of the screen. 0.5f = center of the screen</param>
    /// <param name="y">The y position of the effect. 0 = up side of the screen. 1 = down side of the screen. 0.5f = center of the screen</param>
    /// <param name="time">Time duration of the effect animation in second.</param>
    public static void Pinch(float x, float y, float time)
    {
    ...
    public static void Pinch(float x, float y, float time, float size)
    {
        if (CurrentCamera == null) CurrentCamera = Camera.main;
        CameraPlay_Pinch CP = CurrentCamera.gameObject.AddComponent<CameraPlay_Pinch>() as CameraPlay_Pinch;
        CP.PosX = x;
