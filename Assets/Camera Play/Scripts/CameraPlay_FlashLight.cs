...
[ExecuteInEditMode]
public class CameraPlay_FlashLight : MonoBehaviour
{
    #region Variables
    public Shader SCShader;
    private float TimeX = 1.0f;
    [HideInInspector] [Range(0, 1)] public float _Fade = 1;
    [HideInInspector][Range(0, 1)] public Color _ColorFade = new Color(1, 1, 1, 1);
    ...
    void Start()
    {
        ...
        SCShader = Shader.Find("CameraPlay/FlashLight");
    ...
    void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
    {
        if (SCShader != null)
        {
            ...
            material.SetColor("_ColorFade", _ColorFade);
