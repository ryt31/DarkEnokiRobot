...
[ExecuteInEditMode]
public class CameraPlay_XRay : MonoBehaviour
{
    #region Variables
    ...
    [HideInInspector] [Range(1f, 10f)] public float Size = 1f;
    [HideInInspector] public Color Color = new Color(0, 0.7f, 1, 1);
    [HideInInspector] [Range(0, 30)] public int Speed = 5;
    [HideInInspector] [Range(-1f, 1f)] public float PosX = 0.5f;
    [HideInInspector] [Range(-1f, 1f)] public float PosY = 0.5f;
    [HideInInspector] [Range(0f, 1f)] public float Intensity = 1f;
    [Range(8, 64)] public int Number = 16;
   #endregion
    ...
    void Start()
    {
        SCShader = Shader.Find("CameraPlay/XRay");
    ...
    void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
    {
        if (SCShader != null)
        {
            ...
            material.SetFloat("_Number",(int)Number);
