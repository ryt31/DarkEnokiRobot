...
[ExecuteInEditMode]
public class CameraPlay_Colored : MonoBehaviour
{
    #region Variables
    public Shader SCShader;
    private string ShaderName = "CameraPlay/Colored";
    ...
    [HideInInspector] public Color Colored = new Color(0, 0, 0, 1);
    ...
    void OnRenderImage(RenderTexture sourceTexture, RenderTexture destTexture)
    {
        if (SCShader != null)
        {
            ...
            material.SetColor("_Colored", Colored);
