...
float2 xnormalizedCoord3 = uvst;
float2 normalizedCoord3 = i.texcoord;
...
xnormalizedCoord3.x += _DistortionWave*x;
xnormalizedCoord3.y += _DistortionWave*y;
float4 color3 = tex2D(_MainTex, xnormalizedCoord3+float2(dist,dist));
